...
import { InquiryInquiryCommentsController } from 'src/domain/inquiries/inquiry-comments.controller';
...
@Module({
  ...
  controllers: [InquiriesController, InquiryInquiryCommentsController],
})
